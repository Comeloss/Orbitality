...
public partial class InputEntity {
    ...
    public void AddCollision(int newProjectileId, int newProjectileLauncherId, int newTargetId) {
        ...
        component.ProjectileLauncherId = newProjectileLauncherId;
        component.TargetId = newTargetId;
        AddComponent(index, component);
    }

    public void ReplaceCollision(int newProjectileId, int newProjectileLauncherId, int newTargetId) {
        var index = InputComponentsLookup.Collision;
        var component = CreateComponent<CollisionComponent>(index);
        component.ProjectileId = newProjectileId;
        component.ProjectileLauncherId = newProjectileLauncherId;
