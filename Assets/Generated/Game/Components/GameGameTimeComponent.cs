...
public partial class GameContext {
    ...
    public GameEntity SetGameTime(long newTime) {
        if (hasGameTime) {
        ...
        entity.AddGameTime(newTime);
        return entity;
    }

    public void ReplaceGameTime(long newTime) {
        var entity = gameTimeEntity;
        if (entity == null) {
            entity = SetGameTime(newTime);
        } else {
            entity.ReplaceGameTime(newTime);
        }
    }
...
public partial class GameEntity {
    ...
    public void AddGameTime(long newTime) {
