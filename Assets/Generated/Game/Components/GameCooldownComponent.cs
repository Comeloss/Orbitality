...
public partial class GameEntity {
    ...
    public void AddCooldown(float newCooldown, float newTimeLeft, bool newIsCoolingDown) {
        ...
        component.IsCoolingDown = newIsCoolingDown;
        AddComponent(index, component);
    }

    public void ReplaceCooldown(float newCooldown, float newTimeLeft, bool newIsCoolingDown) {
        var index = GameComponentsLookup.Cooldown;
        var component = CreateComponent<CooldownComponent>(index);
        component.Cooldown = newCooldown;
        component.TimeLeft = newTimeLeft;
